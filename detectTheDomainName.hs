...
printDomains arr = undefined



-}
{-# LANGUAGE FlexibleInstances, UndecidableInstances, OverlappingInstances, OverloadedStrings #-}
...
-- split on " " and use this to feed to parseTLD
printDomains arr = undefined
